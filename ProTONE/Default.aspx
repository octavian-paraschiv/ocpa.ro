...
<asp:Content ID="mainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" id="Div1">
        <h3 style='margin: 0px; padding: 10px 0px 10px 0px;'>&nbsp;Latest ProTONE release:</h3>
    </div>
    ...
    <div runat="server" id="hint">
        <h3 style='margin: 0px; padding: 10px 0px 10px 0px;'>&nbsp;Older ProTONE releases:</h3>
    </div>
    ...
    <br />
     <div runat="server" id="Div2">
        <h3 style='margin: 0px; padding: 10px 0px 10px 0px;'>&nbsp;Experimental ProTONE versions - use at your own risk:</h3>
    </div>
    <table runat="server" id="tblExperimental" cellpadding="0" cellspacing="5">
            <!-- DON'T ADD ANY ELEMENT HERE -->
    </table>
    <br />
    <h4 style='margin: 0px; padding: 10px 0px 10px 0px;'>&nbsp;Developers can also download or clone the ProTONE code from its <a target="new" href="https://github.com/octavian-paraschiv/protone-suite">ProTONE Github Repository</a>.</h4>
